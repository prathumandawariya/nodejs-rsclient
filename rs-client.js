...
const jwtDecoder = require("¡sonwebtoken");
const CryptoUtils = require("./mods/crypto-util");
const SDKLogger = require("./SDK-logger");
const APMLayer = require("./apm/apm-layer");
...
KeepaliveAgent: this.env.get("SDK_KEEPALIVE_AGENT",{ keepAlive: true, freeSocketTimeout:
30000 }),
...
let cookies = this._headers.cookie;
...
const sessionKey = this.buildSessionKey(this._auth.username, this.auth.password);
